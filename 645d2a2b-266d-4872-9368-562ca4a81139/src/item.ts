...
export default class SMedia_Link implements IScript<Props> {
  ...
  spawn(host: Entity, props: Props, channel: IChannel) {
    ...
    if (props.bnw) {
      link.addComponent(new GLTFShape('645d2a2b-266d-4872-9368-562ca4a81139/models/youtube_bnw.glb'))
    } else {
      link.addComponent(new GLTFShape('645d2a2b-266d-4872-9368-562ca4a81139/models/youtube.glb'))
    }
